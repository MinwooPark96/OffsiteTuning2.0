...
def pre_data_rte(mode,config):
    ...
    if mode == "train":
        ...
        d = csv.reader(open("./src/data/RTE/test.tsv", "r"), delimiter='\t')
    '''
    data = load_dataset('glue','rte')
    '''
    if mode=='valid':
...
def pre_data_sst2(mode,config,data_name=None):
    ...
    if mode == "train":
        d = csv.reader(open("./src/data/SST-2/train.tsv", "r"), delimiter='\t', quotechar='"')
    elif mode == "valid" or mode == "validation":
        d = csv.reader(open("./src/data/SST-2/dev.tsv", "r"), delimiter='\t', quotechar='"')
    else:
        d = csv.reader(open("./src/data/SST-2/test.tsv", "r"), delimiter='\t', quotechar='"')
...
#./src/data/restaurant/train.json"
...
def pre_data_restaurant(mode,config):
    ...
    if mode == "train":
        data = []
        with open("./src/data/restaurant/train.json", 'r') as f:
            for line in f:
                data.append(json.loads(line))
    elif mode == "valid":
        data = []
        with open("./src/data/restaurant/test.json", 'r') as f:
            for line in f:
                data.append(json.loads(line))
    else:
        data = []
...
def pre_data_laptop(mode,config):
    ...
    if mode == "train":
        # data = json.load(open("./src/data/laptop/train.json", "r"))
        data = []
        with open("./src/data/laptop/train.json", 'r') as f:
            for line in f:
                data.append(json.loads(line))
    elif mode == "valid":
        # data = json.load(open("./src/data/laptop/test.json", "r"))
        data = []
        with open("./src/data/laptop/test.json", 'r') as f:
            for line in f:
                data.append(json.loads(line))
    else:
        # data = json.load(open("./src/data/laptop/test.json", "r"))
...
def pre_data_imdb(mode,config,data_name=None):
    ...
    if mode == "train":
        data_imdb = csv.reader(open("./src/data/IMDB/train.csv", "r"), delimiter='\t')
    elif mode == "valid":
        data_imdb = csv.reader(open("./src/data/IMDB/dev.csv", "r"), delimiter='\t')
    else:
        data_imdb = csv.reader(open("./src/data/IMDB/test.csv", "r"), delimiter='\t')
...
def pre_data_snli(mode,config):
    ...
    data = []
    if mode == "train":
        with open("./src/data/snli/train.json", 'r') as f:
            for line in f:
                data.append(json.loads(line))
    elif mode == "valid":
        with open("./src/data/snli/dev.json", 'r') as f:
            for line in f:
                data.append(json.loads(line))
    else:
        with open("./src/data/snli/test.json", 'r') as f:
            for line in f:
                data.append(json.loads(line))
...
#./src/data/anli/train.json -> but we do not have!
# if local_map : {0:2,1:1,2:0} else {2:0,1:3,0:1}
def pre_data_anli(mode,config):
    ...
    if mode == "train":
        data = json.load(open("./src/data/anli/train.json"))
    elif mode == "valid":
        data = json.load(open("./src/data/anli/dev.json"))
    else:
        data = json.load(open("./src/data/anli/test.json"))
...
#./src/data/tweeteval/sentiment/train.json
...
def pre_data_tweetevalsentiment(mode,config):
    ...
    data = []
    if mode == "train":
        with open("./src/data/tweeteval/sentiment/train.json", 'r') as f:
            for line in f:
                data.append(json.loads(line))
    elif mode == "valid":
        # data = json.load(open("./src/data/tweeteval/sentiment/dev.json"))
        with open("./src/data/tweeteval/sentiment/dev.json", 'r') as f:
            for line in f:
                data.append(json.loads(line))
    else:
        # data = json.load(open("./src/data/tweeteval/sentiment/test.json"))
        with open("./src/data/tweeteval/sentiment/train.json", 'r') as f:
            for line in f:
                data.append(json.loads(line))
    if mode == "test":
...
#./src/data/movie-rationales/train.json
# if local_map : {0:0, 1;1} else {0:5,1:7}
def pre_data_movierationales(mode,config):
    ...
    if mode == "train":
        data = json.load(open("./src/data/movie-rationales/train.json"))
    elif mode == "valid":
        data = json.load(open("./src/data/movie-rationales/dev.json"))
    else:
        data = json.load(open("./src/data/movie-rationales/test.json"))
    if mode == "test":
...
#./src/data/ethics/justice/justice_train.csv -> but we do not have!
...
def pre_data_ethicsjustice(mode,config):
    ...
    if mode == "train":
        data = csv.reader(open("./src/data/ethics/justice/justice_train.csv"), delimiter=",")
    elif mode == "valid":
        data = csv.reader(open("./src/data/ethics/justice/justice_test.csv"), delimiter=",")
    else:
        data = csv.reader(open("./src/data/ethics/justice/justice_test.csv"), delimiter=",")
...
#./src/data/ethics/deontology/deontology_train.csv -> but we do not have!
# if local_map : {0:0,1:1} else {0:9,1:10]}
def pre_data_ethicsdeontology(mode,config):
    ...
    if mode == "train":
        data = csv.reader(open("./src/data/ethics/deontology/deontology_train.csv"), delimiter=",")
    elif mode == "valid":
        data = csv.reader(open("./src/data/ethics/deontology/deontology_test.csv"), delimiter=",")
    else:
        data = csv.reader(open("./src/data/ethics/deontology/deontology_test.csv"), delimiter=",")
    #_map = {"low":9, "high":10}
    data = [row for row in data if row[0]=='1' or row[0]=='0']
